...
ScrollReveal().reveal(".titulo-inicial", {
  ...scrollRevealOption,
  delay: 1000,
});
ScrollReveal().reveal(".header__content .section-description", {
  ...scrollRevealOption,
  delay: 1500,
});
...
ScrollReveal().reveal(".client__content", {
  duration: 1000,
  interval: 500,
});
...
ScrollReveal().reveal(".text-depoimentos", {
  ...scrollRevealOption,
  origin: "left",
});
